...
public final class SendTicketGrantingTicketAction extends AbstractAction {
	 ...
	 *
	 * @param ticketGrantingTicketCookieGenerator
	...
	protected Event doExecute(final RequestContext context) {
		// requestScope 和 flowScope 获取 ticketGrantingTicketId
		final String ticketGrantingTicketId = WebUtils.getTicketGrantingTicketId(context);

		// 读取 ticketGrantingTicketId 值
		final String ticketGrantingTicketValueFromCookie = (String) context.getFlowScope()
	...
	public void setTicketGrantingTicketCookieGenerator(
		...
		logger.warn(
				"setTicketGrantingTicketCookieGenerator() is deprecated and has no effect. Use constructors instead.");
	}
	...
	public void setCreateSsoSessionCookieOnRenewAuthentications(
			final boolean createSsoSessionCookieOnRenewAuthentications) {
	 ...
	 * Renewed authentications can occur if the service is not allowed to
	 * participate in SSO or if a "renew" request parameter is specified.
	 *
	 * @param ctx
	 *            the request context
