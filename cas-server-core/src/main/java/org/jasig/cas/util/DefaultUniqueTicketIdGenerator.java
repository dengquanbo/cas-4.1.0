...
public class DefaultUniqueTicketIdGenerator implements UniqueTicketIdGenerator {
	 ...
	 * including a {@link DefaultLongNumericGenerator} with a starting value of 1.
	 */
	 ...
	 * maximum length for the random portion.
	 *
	 * @param numericGenerator
	 *            the numeric generator
	...
	public DefaultUniqueTicketIdGenerator(final NumericGenerator numericGenerator,
			final RandomStringGenerator randomStringGenerator, final String suffix) {
	...
	public final String getNewTicketId(final String prefix) {
		...
		final StringBuilder buffer = new StringBuilder(
				prefix.length() + 2 + (StringUtils.isNotBlank(this.suffix) ? this.suffix.length() : 0)
